    ...
    <>
      ...
      <section className="border-y border-hair bg-white px-8 py-16 text-center">
        <div className="mx-auto max-w-[680px]">
          <div className="text-xs font-bold uppercase tracking-[0.14em] text-leaf">The AgriPure process</div>
          <h2 className="mt-3 font-display text-[clamp(32px,5vw,48px)] font-black tracking-[-0.02em] text-forest">
            Seven steps, soil to harvest.
          </h2>
          <p className="mt-4 text-[17px] leading-[1.6] text-fg2">
            Every AgriPure program runs the same seven natural inputs in sequence — restoring the soil,
