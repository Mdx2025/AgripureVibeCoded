...
import { ArrowRight, Sprout, TrendingUp, Ban } from "lucide-react";
...
/** Hero 2 — bold split: deep-forest copy panel with proof points, motion video on the other half. */
    ...
    <section className="grid min-h-[calc(100vh-74px)] overflow-hidden lg:grid-cols-2">
      ...
      <div className="relative order-2 flex items-center overflow-hidden bg-[linear-gradient(160deg,#0c1c10_0%,#1f3318_100%)] px-6 py-16 text-white sm:px-10 lg:order-1">
        ...
        <div className="relative mx-auto w-full max-w-[560px] lg:ml-auto lg:mr-10">
          ...
          <div className="mt-4 text-[13px] text-[#C9DBC0]">
            Trusted by 1,400+ operations · from <span className="font-display text-[15px] font-extrabold text-white">{money(floor)}</span>/acre at volume
          </div>
