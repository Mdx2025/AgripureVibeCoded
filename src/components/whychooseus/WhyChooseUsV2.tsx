...
import { ShieldCheck, TrendingUp, Award, FlaskConical, Package, Droplets, Sprout, Ban, ArrowRight, Check, Sparkles } from "lucide-react";
  ...
  return (
    <div className="bg-white text-forest">
      ...
      <section className="relative flex min-h-[calc(100vh-74px)] flex-col items-center justify-center overflow-hidden bg-[#06160c] px-6 text-center text-white">
        ...
        <div className="relative z-10 mx-auto max-w-[880px] py-20">
          <div className="font-mono text-[12px] uppercase tracking-[0.28em] text-[#BFE89A]">Why choose AgriPure</div>
          <h1 className="mx-auto mt-5 max-w-[16ch] font-display text-[clamp(40px,7.5vw,84px)] font-black leading-[0.97] tracking-[-0.025em] [text-shadow:0_6px_40px_rgba(0,0,0,.6)]">
            Stop fighting crop loss. Prevent it.
          </h1>
          <p className="mx-auto mt-6 max-w-[640px] text-[clamp(17px,2.2vw,21px)] leading-[1.55] text-[#EAF1E3]">
          ...
          <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
            ...
            <Link href="/how-it-works" className="btn-ghost-dark px-7 py-[15px] text-[16px]">See how it works</Link>
          </div>
        </div>
      </section>
      ...
      {/* THE COST OF DOING NOTHING — loss bars + video */}
      <section className="px-6 py-20 sm:px-10">
        <div className="mx-auto grid max-w-container items-center gap-12 lg:grid-cols-2">
          <div className="relative aspect-video overflow-hidden rounded-panel border border-hair shadow-g-lg">
          ...
          <div>
            <div className="text-xs font-bold uppercase tracking-[0.14em] text-[#C0853C]">The cost of doing nothing</div>
            <h2 className="mt-3 font-display text-[clamp(28px,4vw,44px)] font-black tracking-[-0.02em] text-forest">Up to 40% of every harvest is at risk.</h2>
            <p className="mt-4 text-[17px] leading-[1.7] text-fg2">Pests, weeds and disease take a share of the world&apos;s crops every single year. Conventional and organic programs react after the damage is done. AgriPure prevents it — clawing that preventable loss back toward nature&apos;s baseline.</p>
            <div className="mt-7 flex flex-col gap-5 rounded-panel border border-hair bg-white p-6 shadow-g-sm">
              {LOSS.map((b) => (
                <div key={b.label}>
      ...
      <section className="border-y border-hair bg-paper-2 px-6 py-20 sm:px-10">
        <div className="mx-auto max-w-[820px] text-center">
          ...
          <h2 className="mt-3 font-display text-[clamp(28px,4.5vw,46px)] font-black tracking-[-0.02em] text-forest">Everyone else reacts. We prevent.</h2>
          <p className="mx-auto mt-4 text-[18px] leading-[1.7] text-fg2">Conventional and even organic programs wait for a problem, then sell you a spray to chase it — by then the yield is already gone. AgriPure builds the plant&apos;s own defenses and feeds the soil <strong className="text-forest">before</strong> pests, weeds, disease or deficiency take hold.</p>
      ...
      {/* ROI / ORGANIC PREMIUM */}
      <section className="mx-auto max-w-container px-6 py-8 sm:px-10">
        <div className="relative overflow-hidden rounded-panel bg-forest p-10 text-white sm:p-14">
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[1.1fr_1fr]">
            <div>
              ...
              <p className="mt-4 max-w-[520px] text-[17px] leading-[1.7] text-[#D7E5CC]">Recover the yield that preventable loss takes every year, and because the program is natural and residue-conscious, your crop can be certified <strong className="text-white">organic</strong> — and sell at a premium. More crop, at a higher price, from one program.</p>
      ...
      <section className="px-6 pb-24 sm:px-10">
        <div className="mx-auto max-w-container rounded-panel border border-[#D9D6C7] bg-[radial-gradient(120%_130%_at_50%_-20%,#DCEFC8_0%,#EDEAE0_60%)] px-10 py-16 text-center">
          ...
          <p className="mx-auto mt-3.5 max-w-[560px] text-[17px] text-[#4A524B]">The natural program that pays for itself in recovered yield and a premium price. Build yours today.</p>
